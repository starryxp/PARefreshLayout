...
import com.example.xiaopeng.parefreshlayout.api.DefaultRefreshFooterCreater;
import com.example.xiaopeng.parefreshlayout.api.DefaultRefreshHeaderCreater;
import com.example.xiaopeng.parefreshlayout.api.RefreshContent;
...
import com.example.xiaopeng.parefreshlayout.api.ScrollBoundaryDecider;
import com.example.xiaopeng.parefreshlayout.constant.DimensionStatus;
...
import com.example.xiaopeng.parefreshlayout.footer.ClassicsFooter;
import com.example.xiaopeng.parefreshlayout.header.ClassicsHeader;
import com.example.xiaopeng.parefreshlayout.impl.RefreshContentWrapper;
import com.example.xiaopeng.parefreshlayout.impl.RefreshFooterWrapper;
import com.example.xiaopeng.parefreshlayout.impl.RefreshHeaderWrapper;
import com.example.xiaopeng.parefreshlayout.listener.OnLoadmoreListener;
import com.example.xiaopeng.parefreshlayout.listener.OnMultiPurposeListener;
import com.example.xiaopeng.parefreshlayout.listener.OnRefreshListener;
import com.example.xiaopeng.parefreshlayout.listener.OnRefreshLoadmoreListener;
import com.example.xiaopeng.parefreshlayout.util.DelayedRunable;
import com.example.xiaopeng.parefreshlayout.util.DensityUtil;
import com.example.xiaopeng.parefreshlayout.util.ViscousFluidInterpolator;
...
public class PARefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
    ...
    public PARefreshLayout(Context context) {
        super(context);
        this.initView(context, null);
    }

    public PARefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context, attrs);
    }

    public PARefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.initView(context, attrs);
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    public PARefreshLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.PARefreshLayout);

        ViewCompat.setNestedScrollingEnabled(this, ta.getBoolean(R.styleable.PARefreshLayout_srlEnableNestedScrolling, false));
        mDragRate = ta.getFloat(R.styleable.PARefreshLayout_srlDragRate, mDragRate);
        mHeaderMaxDragRate = ta.getFloat(R.styleable.PARefreshLayout_srlHeaderMaxDragRate, mHeaderMaxDragRate);
        mFooterMaxDragRate = ta.getFloat(R.styleable.PARefreshLayout_srlFooterMaxDragRate, mFooterMaxDragRate);
        mHeaderTriggerRate = ta.getFloat(R.styleable.PARefreshLayout_srlHeaderTriggerRate, mHeaderTriggerRate);
        mFooterTriggerRate = ta.getFloat(R.styleable.PARefreshLayout_srlFooterTriggerRate, mFooterTriggerRate);
        mEnableRefresh = ta.getBoolean(R.styleable.PARefreshLayout_srlEnableRefresh, mEnableRefresh);
        mReboundDuration = ta.getInt(R.styleable.PARefreshLayout_srlReboundDuration, mReboundDuration);
        mEnableLoadmore = ta.getBoolean(R.styleable.PARefreshLayout_srlEnableLoadmore, mEnableLoadmore);
        mHeaderHeight = ta.getDimensionPixelOffset(R.styleable.PARefreshLayout_srlHeaderHeight, density.dip2px(100));
        mFooterHeight = ta.getDimensionPixelOffset(R.styleable.PARefreshLayout_srlFooterHeight, density.dip2px(60));
        mDisableContentWhenRefresh = ta.getBoolean(R.styleable.PARefreshLayout_srlDisableContentWhenRefresh, mDisableContentWhenRefresh);
        mDisableContentWhenLoading = ta.getBoolean(R.styleable.PARefreshLayout_srlDisableContentWhenLoading, mDisableContentWhenLoading);
        mEnableHeaderTranslationContent = ta.getBoolean(R.styleable.PARefreshLayout_srlEnableHeaderTranslationContent, mEnableHeaderTranslationContent);
        mEnableFooterTranslationContent = ta.getBoolean(R.styleable.PARefreshLayout_srlEnableFooterTranslationContent, mEnableFooterTranslationContent);
        mEnablePreviewInEditMode = ta.getBoolean(R.styleable.PARefreshLayout_srlEnablePreviewInEditMode, mEnablePreviewInEditMode);
        mEnableAutoLoadmore = ta.getBoolean(R.styleable.PARefreshLayout_srlEnableAutoLoadmore, mEnableAutoLoadmore);
        mEnableOverScrollBounce = ta.getBoolean(R.styleable.PARefreshLayout_srlEnableOverScrollBounce, mEnableOverScrollBounce);
        mEnablePureScrollMode = ta.getBoolean(R.styleable.PARefreshLayout_srlEnablePureScrollMode, mEnablePureScrollMode);
        mEnableScrollContentWhenLoaded = ta.getBoolean(R.styleable.PARefreshLayout_srlEnableScrollContentWhenLoaded, mEnableScrollContentWhenLoaded);
        mEnableScrollContentWhenRefreshed = ta.getBoolean(R.styleable.PARefreshLayout_srlEnableScrollContentWhenRefreshed, mEnableScrollContentWhenRefreshed);
        mEnableLoadmoreWhenContentNotFull = ta.getBoolean(R.styleable.PARefreshLayout_srlEnableLoadmoreWhenContentNotFull, mEnableLoadmoreWhenContentNotFull);
        mEnableFooterFollowWhenLoadFinished = ta.getBoolean(R.styleable.PARefreshLayout_srlEnableFooterFollowWhenLoadFinished, mEnableFooterFollowWhenLoadFinished);
        mEnableOverScrollDrag = ta.getBoolean(R.styleable.PARefreshLayout_srlEnableOverScrollDrag, mEnableOverScrollDrag);
        mFixedHeaderViewId = ta.getResourceId(R.styleable.PARefreshLayout_srlFixedHeaderViewId, View.NO_ID);
        mFixedFooterViewId = ta.getResourceId(R.styleable.PARefreshLayout_srlFixedFooterViewId, View.NO_ID);

        mManualLoadmore = ta.hasValue(R.styleable.PARefreshLayout_srlEnableLoadmore);
        mManualNestedScrolling = ta.hasValue(R.styleable.PARefreshLayout_srlEnableNestedScrolling);
        mManualHeaderTranslationContent = ta.hasValue(R.styleable.PARefreshLayout_srlEnableHeaderTranslationContent);
        mHeaderHeightStatus = ta.hasValue(R.styleable.PARefreshLayout_srlHeaderHeight) ? DimensionStatus.XmlLayoutUnNotify : mHeaderHeightStatus;
        mFooterHeightStatus = ta.hasValue(R.styleable.PARefreshLayout_srlFooterHeight) ? DimensionStatus.XmlLayoutUnNotify : mFooterHeightStatus;
        ...
        int accentColor = ta.getColor(R.styleable.PARefreshLayout_srlAccentColor, 0);
        int primaryColor = ta.getColor(R.styleable.PARefreshLayout_srlPrimaryColor, 0);
        if (primaryColor != 0) {
            if (accentColor != 0) {
    ...
    protected void setStateDirectLoading() {
        if (mState != RefreshState.Loading) {
            ...
            mFooterLocked = true;
            if (mRefreshFooter != null) {
                mRefreshFooter.onStartAnimator(PARefreshLayout.this, mFooterHeight, mFooterExtendHeight);
            }
            if (mLoadmoreListener != null) {
                mLoadmoreListener.onLoadmore(PARefreshLayout.this);
            }
            if (mOnMultiPurposeListener != null) {
                mOnMultiPurposeListener.onLoadmore(PARefreshLayout.this);
    ...
    protected void setStateRefreshing() {
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshListener != null) {
                    mRefreshListener.onRefresh(PARefreshLayout.this);
                }
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(PARefreshLayout.this, mHeaderHeight, mHeaderExtendHeight);
                }
                if (mOnMultiPurposeListener != null) {
                    mOnMultiPurposeListener.onRefresh(PARefreshLayout.this);
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.PARefreshLayout_Layout);
            backgroundColor = ta.getColor(R.styleable.PARefreshLayout_Layout_layout_srlBackgroundColor, backgroundColor);
            if (ta.hasValue(R.styleable.PARefreshLayout_Layout_layout_srlSpinnerStyle)) {
                spinnerStyle = SpinnerStyle.values()[ta.getInt(R.styleable.PARefreshLayout_Layout_layout_srlSpinnerStyle, SpinnerStyle.Translate.ordinal())];
            }
            ta.recycle();
        }
...
//        }
    ...
    @Override
    public PARefreshLayout setFooterHeight(float heightDp) {
        return setFooterHeightPx(DensityUtil.dp2px(heightDp));
    }

    @Override
    public PARefreshLayout setFooterHeightPx(int heightPx) {
    ...
    @Override
    public PARefreshLayout setHeaderHeight(float heightDp) {
        return setHeaderHeightPx(DensityUtil.dp2px(heightDp));
    }

    @Override
    public PARefreshLayout setHeaderHeightPx(int heightPx) {
    ...
    @Override
    public PARefreshLayout setDragRate(float rate) {
        this.mDragRate = rate;
        return this;
    }
     ...
     */
    @Override
    public PARefreshLayout setHeaderMaxDragRate(float rate) {
     ...
     */
    @Override
    public PARefreshLayout setFooterMaxDragRate(float rate) {
     ...
     */
    @Override
    public PARefreshLayout setHeaderTriggerRate(float rate) {
     ...
     */
    @Override
    public PARefreshLayout setFooterTriggerRate(float rate) {
     ...
     */
    @Override
    public PARefreshLayout setReboundInterpolator(Interpolator interpolator) {
     ...
     */
    @Override
    public PARefreshLayout setReboundDuration(int duration) {
     ...
     */
    @Override
    public PARefreshLayout setEnableLoadmore(boolean enable) {
     ...
     */
    @Override
    public PARefreshLayout setEnableRefresh(boolean enable) {
     ...
     */
    @Override
    public PARefreshLayout setEnableHeaderTranslationContent(boolean enable) {
     ...
     */
    @Override
    public PARefreshLayout setEnableFooterTranslationContent(boolean enable) {
     ...
     */
    @Override
    public PARefreshLayout setDisableContentWhenRefresh(boolean disable) {
     ...
     */
    @Override
    public PARefreshLayout setDisableContentWhenLoading(boolean disable) {
     ...
     */
    @Override
    public PARefreshLayout setEnableAutoLoadmore(boolean enable) {
     ...
     */
    @Override
    public PARefreshLayout setEnableOverScrollBounce(boolean enable) {
     ...
     */
    @Override
    public PARefreshLayout setEnablePureScrollMode(boolean enable) {
     ...
     */
    @Override
    public PARefreshLayout setEnableScrollContentWhenLoaded(boolean enable) {
     ...
     */
    @Override
    public PARefreshLayout setEnableScrollContentWhenRefreshed(boolean enable) {
     ...
     */
    @Override
    public PARefreshLayout setEnableLoadmoreWhenContentNotFull(boolean enable) {
     ...
     */
    @Override
    public PARefreshLayout setEnableOverScrollDrag(boolean enable) {
     ...
     */
    @Override
    public PARefreshLayout setEnableFooterFollowWhenLoadFinished(boolean enable) {
     ...
     */
    @Override
    public PARefreshLayout setRefreshHeader(RefreshHeader header) {
     ...
     */
    @Override
    public PARefreshLayout setRefreshHeader(RefreshHeader header, int width, int height) {
        if (header != null) {
            if (mRefreshHeader != null) {
     ...
     */
    @Override
    public PARefreshLayout setRefreshFooter(RefreshFooter footer) {
     ...
     */
    @Override
    public PARefreshLayout setRefreshFooter(RefreshFooter footer, int width, int height) {
        if (footer != null) {
            if (mRefreshFooter != null) {
     ...
     */
    @Override
    public PARefreshLayout getLayout() {
        return this;
    }
     ...
     */
    @Override
    public PARefreshLayout setOnRefreshListener(OnRefreshListener listener) {
     ...
     */
    @Override
    public PARefreshLayout setOnLoadmoreListener(OnLoadmoreListener listener) {
     ...
     */
    @Override
    public PARefreshLayout setOnRefreshLoadmoreListener(OnRefreshLoadmoreListener listener) {
        this.mRefreshListener = listener;
        this.mLoadmoreListener = listener;
        this.mEnableLoadmore = mEnableLoadmore || (!mManualLoadmore && listener != null);
        return this;
     ...
     */
    @Override
    public PARefreshLayout setOnMultiPurposeListener(OnMultiPurposeListener listener) {
     ...
     */
    @Override
    public PARefreshLayout setPrimaryColorsId(@ColorRes int... primaryColorId) {
     ...
     */
    @Override
    public PARefreshLayout setPrimaryColors(int... colors) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public PARefreshLayout setLoadmoreFinished(boolean finished) {
     ...
     */
    @Override
    public PARefreshLayout finishRefresh() {
     ...
     */
    @Override
    public PARefreshLayout finishLoadmore() {
     ...
     */
    @Override
    public PARefreshLayout finishRefresh(int delayed) {
     ...
     */
    @Override
    public PARefreshLayout finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastRefreshingTime;
     ...
     */
    @Override
    public PARefreshLayout finishRefresh(int delayed, final boolean success) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Refreshing) {
                    if (mRefreshHeader != null && mRefreshContent != null) {
                        int startDelay = mRefreshHeader.onFinish(PARefreshLayout.this, success);
     ...
     */
    @Override
    public PARefreshLayout finishLoadmore(int delayed) {
     ...
     */
    @Override
    public PARefreshLayout finishLoadmore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastLoadingTime;
     ...
     */
    @Override
    public PARefreshLayout finishLoadmore(int delayed, final boolean success) {
     ...
     */
    @Override
    public PARefreshLayout finishLoadmore(int delayed, final boolean success, final boolean noMoreData) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading) {
                    if (mRefreshFooter != null && mRefreshContent != null) {
                        final int startDelay = mRefreshFooter.onFinish(PARefreshLayout.this, success);
                        if (startDelay < Integer.MAX_VALUE) {
                            if (mIsBeingDragged) {
                                mTouchSpinner = 0;
                                mTouchY = mLastTouchY;
     ...
     */
    @Override
    public PARefreshLayout finishLoadmoreWithNoMoreData() {
        long passTime = System.currentTimeMillis() - mLastLoadingTime;
     ...
     */
    @Override
    public PARefreshLayout resetNoMoreData() {
    ...
    public static class RefreshKernelImpl implements RefreshKernel {
        ...
        PARefreshLayout layout;

        public RefreshKernelImpl(PARefreshLayout layout) {
            this.layout = layout;
        }
